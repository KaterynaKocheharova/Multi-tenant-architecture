...
5. Для таблиць із глобальною видимістю на основі поля isGlobal = true продумати особливу політику.
...
3. Фільтрація тенантів лише на рівні застосунку (без RLS).
   ...
   - Мінуси: один пропущений `where schoolId = ...` призводить до тихого витоку даних; відсутній захист на рівні БД.
