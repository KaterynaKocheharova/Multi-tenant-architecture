<!-- ТАБЛИЦІ ЩО ДОСТУПНІ ЛИШЕ ТЕНАНТАМ -->

1. репорти
2. плани уроків
3. приватні дани вчителя
4. приватні дані студент
5. івенти якщо глобальні

<!-- ТАБЛИЦІ ЩО ДОСТУПНІ ВСІМ -->

1. публічний профайл учителя (читання)
2. публічний профал учня (читання)
3. глобальні івенти (читання, реєстрація)
